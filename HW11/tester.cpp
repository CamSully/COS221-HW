...
int main()
{
 ...
 // Create a graph for Figure 25.3
 int edges2[][3] =
 {
 {0, 1, 2}, {0, 3, 8},
 {1, 0, 2}, {1, 2, 7}, {1, 3, 3},
 ...
 {4, 2, 5}, {4, 3, 6}
 }; // 14 edges in Figure 25.3

 // 7 undirected edges in Figure 25.3
 const int NUMBER_OF_EDGES2 = 14;
 ...
 graph2.printWeightedEdges();
	...
	cout << "PRIM'S SPANNING TREE ##################################" << endl << endl << endl;
MST dude = graph1.getMinimumSpanningTree(0);
	cout << "KRUSKAL SPANNING TREE ##################################" << endl << endl << endl;
// int dude2 = graph1.getKruskalMST();
